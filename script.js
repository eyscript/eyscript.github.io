...
class GMechanincs1 extends Phaser.Scene{
    ...
    preload(){
       ...
       this.load.image("zone", "assets/etiquetaname.png");
    ...
    create(){
     ...
     // this.add.image(462,130, "RE").setOrigin(0).setScale(0.16, 0.135).setName("fantas");
      this.add.image(315,245, "zone").setOrigin(0.5).setScale(1, 0.5).setInteractive({dropZone:true}).setName("foca");
      this.add.image(515,245, "zone").setOrigin(0.5).setScale(1, 0.5).setInteractive({dropZone:true}).setName("fantas");
      console.log(this.children.list)
...
var content = [["EL FANTASMA FELIPE ESTA MUY CONTENTO. ", "HOY IRÁ A LA FERIA CON SU AMIGA, LA FOCA FANI. ¡QUÉ DIVERTIDO!",
